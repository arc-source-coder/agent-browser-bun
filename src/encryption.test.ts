...
const generateTestKey = () => randomBytes(32);
const generateTestKeyHex = () => randomBytes(32).toString('hex');
...
describe('encryption', () => {
  ...
  describe('malformed payload detection', () => {
    ...
    it('should throw error for truncated auth tag', () => {
      ...
      const truncatedTag = randomBytes(4); // Random 4 bytes won't match
      const malformed: EncryptedPayload = {
        ...encrypted,
    ...
    it('should throw error for completely wrong auth tag length', () => {
      ...
      const wrongTag = randomBytes(16); // Same length as real tag
      const malformed: EncryptedPayload = {
        ...encrypted,
